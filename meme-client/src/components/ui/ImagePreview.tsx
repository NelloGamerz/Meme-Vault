...
export const ImagePreview: React.FC<ImagePreviewProps> = ({
  ...
  return (
    <div className={`rounded-lg overflow-hidden ${isZoomed ? 'fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center p-4' : ''}`}>
      {isLoading && (
        <div className="flex items-center justify-center bg-gray-100 animate-pulse" style={{
