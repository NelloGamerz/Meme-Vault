...
import { Home, Search, PlusSquare, Settings, LogOut, User } from 'lucide-react';
...
export const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 flex flex-col py-6 px-3">
